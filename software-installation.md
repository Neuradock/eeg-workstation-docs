...
| Item | Status |
|---|---|
| [eeg-workstation-software](https://github.com/Neuradock/eeg-workstation-software) repository created | To be finalized |
| NeuraDock Recording Software release uploaded | To be finalized |
| Official recording software version number | To be finalized |
| Supported operating systems | To be finalized |
| Installer package names | To be finalized |
| Required Python version | To be finalized |
| Required Python dependencies | To be finalized |
| USB driver requirements | To be finalized |
| Bluetooth pairing workflow | To be finalized |
| Official verification command | To be finalized |
| Example script names | To be finalized |
| Sample data repository availability | To be finalized |
| Known installation issues | To be finalized |
